...
var hidePole1 = function() {
	var checkboxPole2 = $("div[data-name='Поле_2'] input");
	var fieldPole1 = $("div.column-container > div[data-name='Поле_1']")

	if (checkboxPole2.is(":checked")) {
		fieldPole1.show();
	} else {
		fieldPole1.hide();
	}
